...
SUM(Total_Revenue) AS Total_Rev, SUM(Total_Revenue)*100/ (SELECT Sum(Total_Revenue) FROM Customer_Churn)AS Percentage
FROM Customer_Churn
...
CREATE VIEW Churn_Data_vw AS 
SELECT * FROM prod_Churn where Customer_Status In ('Churned', 'Stayed')

CREATE VIEW Join_Data_vw as
